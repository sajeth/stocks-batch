...
//
//@Component("auto15MinItemWriter")
//@StepScope
//public class Auto15MinItemWriter implements ItemWriter<StockDTO> {
//
//	private static final Logger log = Logger.getLogger("Auto15MinItemWriter");
//	
