...
//@Component
public class GenericJobLauncherDetails extends QuartzJobBean {
    ...
    public GenericJobLauncherDetails() {
...
//     * @param taskExecutor
//     */
//    public GenericJobLauncherDetails(final JobLocator jobLocator,final JobLauncher jobLauncher,final BatchJobRepository batchJobRepository,
